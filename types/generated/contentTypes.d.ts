...
export interface ApiChapterChapter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    end_time_seconds: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::chapter.chapter'
    > &
      Schema.Attribute.Private;
    mix: Schema.Attribute.Relation<'manyToOne', 'api::mix.mix'>;
    publishedAt: Schema.Attribute.DateTime;
    start_time_seconds: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    streaming_links: Schema.Attribute.JSON;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 200;
      }>;
    track_name: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 200;
      }>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCuratorCurator extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::curator.curator'
    >;
    mixes: Schema.Attribute.Relation<'manyToMany', 'api::mix.mix'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiMixMix extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    curators: Schema.Attribute.Relation<'manyToMany', 'api::curator.curator'>;
    ...
    is_premium: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::mix.mix'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiShowShow extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accent_color: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'#FE0000'>;
    ...
    mixes: Schema.Attribute.Relation<'oneToMany', 'api::mix.mix'>;
    primary_curator: Schema.Attribute.Relation<
      'manyToOne',
      'api::curator.curator'
    >;
    publishedAt: Schema.Attribute.DateTime;
